...
<script type="text/javascript">
	$(document).ready(
			function() {
				...
				$("#write").on("click", function() {
					...
					location.href = "CRMMarkChanceWrite"
	...
	function ChanceList(list) {
		...
		for (var i = 0; i < list.length; i++) {
			...
			html += "<div id=\"div_d\">||</div> <div id=\"companyName\">"
					+ list[i].CCNAME + "</div>"
			html += "<div id=\"div_d\"\">||</div><div id=\"man\">"
					+ list[i].MNNAME + "</div><br />"
			html += "<div id=\"status\">" + list[i].PSENAME + "</div>"
			html += "<div id=\"div_d\">||</div><div id=\"day\">"
					+ list[i].MARK_START_DATE + "</div></div></div>"
...
<body>
	...
	<div class="content_area">
		<div class="content_nav">HeyWe &gt; CRM &gt; 영업기회</div>


		<div class="content_title">
			영업기회 <img src="resources/images/erp/crm/write.png" id="write"
		...
		<div class="search">
			...
			<form action="#" id="dataForm" method="post">
				<input type="hidden" id="chanceno" name="chanceno"> <input
				...
				<div class="search1">
					<input type="text" id="searchTxt" name="searchTxt"
						placeholder="영업명을 입력해주세요." />&nbsp <select id="select1"
						name="select1">
						<option value="10">진행상태(전체)</option>
						<option value="0">진행중</option>
						<option value="1">종료(성공)</option>
						<option value="2">종료(실패)</option>
			...
			<div class="search3">
				<input type="text" width="300px" height="30px" title="시작기간선택"
					id="date_start" name="date_start" value="" readonly="readonly" placeholder="영업시작일" />
				~ <input type="text" title="종료기간선택" id="date_end" name="date_end"
					value="" readonly="readonly" placeholder="영업종료일" />
			</div>  
			<div class="search2">
