	...
	$(document).ready(
			function() {
				...
				$("#writeImg").on(
						...
						function() {
							...
							if ($.trim($("#Mark_Name").val()) == "") {
								makeAlert(1, "", "영업명을 입력하세요.", true, null);
								$("#Mark_Name").focus();
							} else if ($.trim($("#mngr").val()) == "") {
								makeAlert(1, "", "고객을 선택하세요.", true, null);
							} else if ($.trim($("#date_start").val()) == "") {
								makeAlert(1, "", "영업시작일을 선택하세요.", true, null);
							} else if ($.trim($("#emp").val()) == "") {
								makeAlert(1, "", "담당자를 선택하세요.", true, null);
							} else {
								makeConfirm(1, "영업기회 작성", "작성하시겠습니까?", true,
										function() {
											fileuploadU();
										})
							}
				...
				$("#backImg").on("click", function() {
					makeConfirm(1, "기회 등록", "취소하시겠습니까?", true, function(){
	...
	<div class="content_area">
		...
		<form action="#" id="dataForm" method="post">
			<input type="hidden" name="att" id="att" /> <input type="hidden"
				id="stdt" name="stdt" value="${stdt}" /> <input type="hidden"
				id="eddt" name="eddt" value="${eddt}" /> <input type="hidden"
				name="empsearchtxt" id="empsearchtxt" /> <input type="hidden"
				name="selectemp" id="selectemp" /> <input type="hidden"
				name="sEmpNo" value="${sEmpNo}" /> <input type="hidden"
				name="cstmsearchtxt" id="cstmsearchtxt" /> <input type="hidden"
				name="selectcstm" id="selectcstm" /> <input type="hidden"
				name="mngrsearchtxt" id="mngrsearchtxt" /> <input type="hidden"
				name="selectmngr" id="selectmngr" />
					...
					<tbody>
						<tr>
							...
							<td id="tdright"><input type="text" width="500px"
								id="Mark_Name" name="Mark_Name" /></td>
						</tr>
						<tr>
							<td id="tdleft">담당자(고객) *</td>
							<td id="tdright"><input type="text" id="mngr" name="mngr_no" readonly="readonly" class="grey" >
								<input type="button" value="선택" id="mngrBtn" /></td>
						</tr>
						<tr>
							<td id="tdleft">진행상태</td>
							<td id="tdright"><select id="Progress_State"
								name="Progress_State"></select></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td id="tdright"><input type="text" width="500px"
								id="Sales_Div_Dtl" name="Sales_Div_Dtl" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td id="tdright"><input type="text" width="300px"
								...
								value="" readonly="readonly" class="grey" /></td>
						</tr>
						<tr>
							<td id="tdleft">담당자(자사) *</td>
							<td id="tdright"><input type="text" id="emp" name="Emp_No" readonly="readonly" class="grey"/>
