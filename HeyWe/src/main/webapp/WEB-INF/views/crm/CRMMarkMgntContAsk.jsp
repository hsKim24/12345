...
$(document).ready(function(){ 
	...
	$("#checkNego").on("change", function(){
		if ($("input:checkbox[id='checkNego']").is(":checked") == true){
			$(".negoDiv").css("display", "");
			}
		else{
			$(".negoDiv").css("display", "none");
	...
	$("#checkCont").on("change", function(){
		if ($("input:checkbox[id='checkCont']").is(":checked") == true){
			$(".contDiv").css("display", "");
			}
		else{
	...
	$("#writeBtn").on("click", function(){
		$("#dataForm").attr("action", "CRMMarkMgntContUpdate");
		$("#dataForm").submit();
	});
...
<c:import url="/topLeft">
	...
	<div class="content_area">
		<div class="content_nav">HeyWe &gt; CRM &gt; 영업현황 &gt; 계약</div>
		<!-- 내용 영역 -->
		<div class="content_title">계약 상세</div> 
		<div class="title">
		...
		<div class="checkbox">
			...
			<input type="checkbox" value="제안" id="checkOffer"/><label for="checkOffer">제안</label>
			<input type="checkbox" value="협상" id="checkNego"/><label for="checkNego">협상</label>
			<input type="checkbox" value="계약" id="checkCont" checked="checked"/><label for="checkCont">계약</label>
		</div>
		<div class="crmInfo">
			<div class="commonDiv">
				...
				<colgroup>
					...
					<tbody>
						<tr>
							...
							<td id="tdright">${dtl.CON}</td>
						</tr>
						<tr>
							<td class="tdleftCont">계약일</td>
							<td id="tdright">${dtl.CONT_DATE}</td>
						</tr>
						<tr>
							<td class="tdleftCont">계약시작일</td>
							<td id="tdright">${dtl.CON_START_DATE}</td>
						</tr>
						<tr>
							<td class="tdleftCont">계약종료일</td>
							<td id="tdright">${dtl.CON_FINISH_DATE}</td>
						</tr>
						<tr>
							<td class="tdleftCont">계약금</td>
							<td id="tdright">${dtl.AMT}</td>
						</tr>
						<tr>
							<td class="tdleftCont">부가세 여부</td>
							<td id="tdright">${dtl.CON_SURTAX_WHETHER}</td>
						</tr>
						<tr>
							<td class="tdleftCont">대금지급조건</td>
							<td id="tdright">${dtl.PAY_PROV_COND}</td>
						</tr>
						<tr>
							<td class="tdleftCont">하자보증기간</td>
							<td id="tdright">${dtl.FLAW_ASSUR_DATE}</td>
						</tr>
			...
			<input type="hidden" id="pspCheck" name="pspCheck" value="3">
			<div id="content">
				<div id="contentInput">
