...
$(document).ready(function(){
	...
	$("#writeBtn").on("click", function(){
		$("#dataForm").attr("action", "OfferWrite");
		$("#dataForm").submit();
	});
	...
	$("#date_start").datepicker({
		...
		onSelect:function(dateText, inst){
            ...
            if (endDate > startDate) {
            	makeAlert(1, "", "시작 기간은 과거로 설정하세요.", true, null);
            	//달력에 종료 날짜 넣어주기
	...
	$("#date_end").datepicker({
		...
		onSelect:function(dateText, inst){
            ...
            if (startDate > endDate) {
            	makeAlert(1, "", "종료 기간은 미래로 설정하세요.", true, null);
            	//달력에 종료 날짜 넣어주기
...
<c:import url="/topLeft">
	...
	<div class="content_area">
		...
		<div class="content_title">제안 관리</div>
		<div class="writeDiv"><img src="resources/images/erp/crm/write.png" id="writeBtn" style="cursor:pointer" />
		</div>
		<div class="mok">
		<form action="3" id="dataForm" method="post">
		...
		<input type="hidden" id="eddt" name="eddt" value="${eddt}" />
			<div class="search">
				...
				<select name="searchGbn" id="searchGbn">
	            	<option value="0">제안날짜</option>
	            	<option value="1">제안 마감날짜</option>            	
	            	<option value="2">영업시작일</option>            	
	            	<option value="3">영업종료일</option>            	
	            </select>
