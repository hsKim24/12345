...
$(document).ready(function(){ 
	...
	$("#writeBtn").on("click", function(){
		$("#dataForm").attr("action", "ContWrite");
		$("#dataForm").submit();
	});
});
//아작스
...
<c:import url="/topLeft">
	...
	<div class="content_area">
		...
		<div class="content_title">계약 관리</div>
			...
			<div class="search">
				...
				<input type="text" placeholder="고객 또는 고객사명을 입력해주세요." id="select2" name="select2"/> <br /><br />
				 ...
				 <select name="searchGbn" id="searchGbn">
	            	<option value="0">계약일</option>
	            	<option value="1">계약시작일</option>            	
	            	<option value="2">계약종료일</option>
	            	<option value="3">영업시작일</option>
	            	<option value="4">영업종료일</option>
	            </select> 
