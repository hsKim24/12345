...
<c:import url="/topLeft">
	...
	<div class="content_area">
		<div class="content_nav">HeyWe &gt; CRM &gt; 영업현황 &gt; 협상 &gt; 협상등록 &gt; 제안 선택</div>
		<div class="content_title">협상 등록 &gt; 제안 선택</div>
		<div class="mok"> 
		...
		<input type="hidden" id="eddt" name="eddt" value="${eddt}" />
			<div class="search">
				<div class="search2">
				<input type="text" placeholder="영업명을 검색해주세요." id="select1" name="select1"/>
				<input type="text" placeholder="고객 또는 고객사명을 검색해주세요." id="select2" name="select2"/> <br /><br />
				</div>
				<div class="search1">
